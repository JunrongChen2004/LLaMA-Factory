...
def main():
    ...
    parser.add_argument(
        "--base-dir",
        type=Path,
        default=Path("/data/junrong/o3_15steps"),
        help="Root directory containing app subdirectories (default: /data/junrong/o3_15steps)",
    )
    parser.add_argument(
        "--annotated-jsonl",
        type=Path,
    ...
    parser.add_argument(
        "--all-result",
        type=Path,
        default=Path("/data/junrong/o3_15steps/all_result.json"),
        help="Path to all_result.json containing success/fail per run",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("/data/junrong/o3_15steps_llamafactory_sft.jsonl"),
